...
export function createPanel(width, height, withWires = false){
    ...
    // middleMiddle.stretch = GUI.Image.STRETCH_NINE_PATCH;
    // middleMiddle.sliceLeft = 38;
    // middleMiddle.sliceTop = 20;
    // middleMiddle.sliceBottom = 315;
    // middleMiddle.sliceRight = 320;
    // middleMiddle.autoScale = true;
