...
const allBuildings = { 
    ...
    protector:{name:"Protector", class:"Booster",cost:1,  width:2,height:3,shape:[1,5,1,5,2,1], color:"#324d62", drawable:false, BUID: 6,
        stats:{kineticFirepower:1, ammoStorage:15}, 
        effects:{armor:1,energyResistance:1}},
    energyResistance:{name:"Energy Shield", class:"Shield",cost:2, width:6,height:3,shape:[0,5,5,5,5,0,5,5,1,1,5,5,5,1,1,1,1,5], color:"#546572", drawable:false, BUID: 7,
        effects:{energyResistance:1}},
    radar:{name:"Radar", class:"Radar",cost:2, width:3,height:3,shape:[0,1,0,1,1,1,0,1,0], color:"#546572", drawable:false, BUID: 8,
        stats:{radarRange:2, health:10}, effects:{radarRange:2}},
    powerRing:{name:"Power Ring", class:"Booster", cost:9, width:6, height:6, shape:[0,1,0,0,1,0,1,1,1,1,1,1,0,1,5,5,1,0,0,1,5,5,1,0,1,1,1,1,1,1,0,1,0,0,1,0], color:"#fcc15b", drawable:false, BUID: 9,
        effects:{energyFirepower:5, powerStorage:10}},
    core:{name:"Core", class:"Core",cost:9, width:3,height:3,shape:[1,1,1,1,8,1,1,1,1], color:"#a9bcdb", moveable:false, returnable:false, drawable:false, BUID: 0,
        stats:{health:20, energyFirepower:2, powerStorage:1000, powerDraw:0.2, fireRate:2}},
    matador:{name:"Matador", class:"Booster",cost:1,  width:2,height:3,shape:[1,5,1,5,2,1], color:"#324d62", drawable:false, BUID: 10,
        stats:{kineticFirepower:1, ammoStorage:15, radarRange:2}, 
        effects:{armor:1,energyResistance:1, radarRange:2}},
    salvador:{name:"Salvador", class:"Weapon",cost:5,  width:4,height:3,shape:[0,1,1,1,2,1], color:"#324d62", drawable:false, BUID: 11,
